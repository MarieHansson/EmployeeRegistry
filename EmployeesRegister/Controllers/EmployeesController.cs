...
namespace EmployeesRegister.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            return View(db.Employees.ToList()); //Ej i synk (11/5, föreläsning)
        }
        ...
        {
            var model = db.Employees.Where(i => i.Department == "Sport").ToList(); //Jag skapar detta Lambda-uttryck, enligt Vy-uppgiften.
            return View(model);
        }

        //Mitt 2:a tillägg:
        public ActionResult TopDepartment()
        {
            var model = db.Employees.Where(i => i.Department == "Top Department").ToList(); //Jag skapar detta Lambda-uttryck, enligt Vy-uppgiften.
            return View(model);
        }
